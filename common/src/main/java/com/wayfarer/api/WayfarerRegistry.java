...
public class WayfarerRegistry {
    ...
    public static void registerWaypoint(String name, BlockPos pos, ResourceLocation iconId, int color) {
    ...
    public static void sendWaypoint(ServerPlayer player, String name, BlockPos pos,
            ResourceLocation icon, int color, WaypointType type) {
        sendWaypoint(player, name, pos, icon, color, type, LocatorType.STANDARD);
    }

    public static void sendWaypoint(ServerPlayer player, String name, BlockPos pos,
            ResourceLocation icon, int color, WaypointType type, LocatorType locatorType) {
    ...
    public static boolean hasWaypointAt(BlockPos pos) {
        return getWaypoints().stream().anyMatch(wp -> wp.pos.equals(pos));
    }

    public static void removeWaypointAt(BlockPos pos) {
        STATIC_PROVIDER.getWaypoints().removeIf(wp -> wp.pos.equals(pos));
    }
    ...
    public static class Waypoint {
        ...
        public Waypoint(String name, BlockPos pos, ResourceLocation icon, int color, WaypointType type) {
